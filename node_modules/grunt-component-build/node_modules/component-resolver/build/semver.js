...
Resolver.prototype.resolveSemverRemotely = wrapGenerator.mark(function(branch, name, ref) {
  var remote, versions, version;

  return wrapGenerator(function($ctx1) {
    while (1) switch ($ctx1.prev = $ctx1.next) {
    case 0:
      return $ctx1.delegateYield(this.remote.resolve(branch.resolvedRemotes, name), "t4", 1);
    case 1:
      remote = $ctx1.t4;
    ...
    case 4:
      return $ctx1.delegateYield(remote.versions(name), "t5", 5);
    case 5:
      versions = $ctx1.t5;
